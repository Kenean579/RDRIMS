          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-6">
            <div class="flex justify-between items-start mb-4">
               ...
               <template v-if="!isRegistered">
                 <button v-if="canRegister" @click="registerForEvent" class="btn bg-brand hover:bg-brand-dark text-white px-6 font-black capitalize tracking-widest text-[11px] shadow-lg shadow-blue-500/20">Register</button>
                 <span v-else class="text-[10px] text-rose-500 font-black capitalize tracking-widest py-2">Registration Closed</span>
               </template>
               <template v-else>
                 <span class="btn bg-emerald-100 text-emerald-700 px-6 font-black capitalize tracking-widest text-[11px] pointer-events-none">Registered ✓</span>
               </template>
            </div>
