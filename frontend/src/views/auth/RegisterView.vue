  ...
  <div class="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="w-full max-w-lg animate-fade">
      ...
      <div class="flex flex-col items-center mb-8">
        <div class="h-14 w-14 bg-brand rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-brand/20 mb-6 hover:rotate-6 transition-transform cursor-pointer" @click="router.push('/')">
          R
        </div>
