  ...
  <div class="flex flex-col gap-16 pb-16">
        ...
        <form @submit.prevent="submitProblem" class="space-y-6">
          <div>
            ...
            <input v-model="problemForm.title" type="text" required
              class="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand/30 focus:border-brand outline-none"
          ...
          <div>
            ...
            <textarea v-model="problemForm.description" required rows="5" minlength="50"
              class="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand/30 focus:border-brand outline-none resize-none"
          ...
          <button type="submit" :disabled="submitting" class="w-full px-6 py-3 bg-brand text-white font-bold rounded-xl shadow-lg shadow-brand/30 hover:shadow-brand/50 transition-all disabled:opacity-60">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
      ...
      <div v-if="loading.partners" class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div v-for="i in 3" :key="i" class="bg-white rounded-2xl border border-slate-200 p-6 animate-pulse h-32"></div>
      </div>
