<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
    <div class="bg-white rounded-3xl p-16 border border-slate-100 shadow-xl shadow-brand/5 max-w-2xl mx-auto">
      <div class="w-24 h-24 bg-brand/10 text-brand rounded-full items-center justify-center flex mx-auto mb-8">
      ...
      <h1 class="text-4xl font-black text-slate-800 tracking-tight mb-4">{{ title }}</h1>
      ...
      <router-link to="/" class="inline-flex items-center gap-2 px-8 py-3.5 bg-brand text-white font-bold rounded-xl shadow-lg shadow-brand/30 hover:-translate-y-0.5 transition-transform">
...
const title = computed(() => {
  ...
  if (route.path.includes('community')) return 'Community Problems'
