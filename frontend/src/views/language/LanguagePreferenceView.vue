      ...
      <form @submit.prevent="savePreference" class="flex flex-col gap-6">
        <div>
          ...
          <div class="space-y-3">
            ...
            <label class="flex items-center gap-4 p-4 rounded-xl border border-slate-100 cursor-pointer hover:border-blue-200 hover:bg-blue-50/30 transition group" :class="{ 'border-blue-300 bg-blue-50/50': locale === 'am' }">
