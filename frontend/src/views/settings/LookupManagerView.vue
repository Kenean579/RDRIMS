<template>
  <div class="flex flex-col gap-8 pb-12 animate-fade card">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">System Lookups</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div class="lg:col-span-3 space-y-6">
        <div v-if="!activeTable" class="card p-24 text-center">
          ...
          <p class="text-sm font-black text-slate-600">Select a lookup table to begin management.</p>
        </div>
    ...
    <Modal :show="showAdd || !!editingItem" :title="editingItem ? 'Edit Lookup' : 'Add New Option'" @close="closeModal">
      <form @submit.prevent="saveItem" class="space-y-4">
        ...
        <div class="flex justify-end gap-3 pt-6 border-t border-slate-100">
           ...
           <button type="submit" class="btn btn-primary px-10 shadow-lg shadow-blue-500/20">Save</button>
        </div>
      </form>
    </Modal>
