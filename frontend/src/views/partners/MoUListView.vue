<template>
  <div class="flex flex-col gap-6 card">
    <div class="mb-2">
      <router-link to="/app/partners" class="inline-flex items-center text-sm font-medium text-slate-500 hover:text-blue-600 transition">
    ...
    <div v-else class="space-y-4">
      <div v-for="m in mous" :key="m.id" class="card p-8 group card-hover flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="w-10 h-10 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-400 group-hover:text-blue-600 group-hover:bg-blue-50 transition duration-300">
