    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div v-show="currentStep === 0" class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="md:col-span-2">
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Title <span class="text-rose-500">*</span></label>
          ...
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Call for Proposal</label>
          ...
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Proposal Type <span class="text-rose-500">*</span></label>
            <LookupSelect v-model="form.type_id" lookup-key="proposal_types" placeholder="Select type" />
          </div>
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Academic Year</label>
          ...
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Budget (ETB) <span class="text-rose-500">*</span></label>
      ...
      <div v-show="currentStep === 1" class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        ...
        <div class="space-y-6">
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Keywords <span class="text-rose-500">*</span></label>
          ...
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Abstract <span class="text-rose-500">*</span></label>
          ...
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Objectives <span class="text-rose-500">*</span></label>
            <textarea v-model="form.objectives" required rows="4"
              class="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand/30 focus:border-brand outline-none resize-none transition-all"
              placeholder="1. First objective&#10;2. Second objective&#10;3. Third objective"></textarea>
          </div>
          <div>
            <label class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Methodology <span class="text-rose-500">*</span></label>
        ...
        <div v-else class="space-y-4">
          <div v-for="(inv, index) in form.investigators" :key="index"
            ...
            <div class="flex items-center justify-between mb-4">
              <span class="text-xs font-black text-slate-400 uppercase tracking-widest">Member #{{ index + 1 }}</span>
...
const steps = ['Summary', 'Details', 'Team']
