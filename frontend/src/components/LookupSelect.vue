  ...
  <div class="relative">
    ...
    <div class="relative">
      <select 
        ...
        class="appearance-none w-full px-4 py-3 bg-white border border-slate-100 text-slate-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-brand focus:border-brand font-bold text-sm hover:border-slate-300 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
